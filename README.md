# Video-Prediction  
- This program takes, as a parameter, a path of a video in which the robotic hand tries to grasp an object.   
- This program uses a CNN to classfy each frame in a video whether a try was succesful or not.  
